    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section id="demo" className="px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-cyan-400/10 to-purple-400/10 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
            <div className="bg-white/5 rounded-2xl p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-semibold text-white">Media Optimizer Demo</h3>
                <div className="flex items-center gap-3">
                  <button
                    onClick={handleDemoStart}
                    disabled={isPlaying}
                    className="flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 text-white px-4 py-2 rounded-lg transition-colors"
                  >
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-6">
                <div className="space-y-4">
                  <h4 className="text-lg font-medium text-white">Original File</h4>
                  <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-lg p-6 border border-red-500/30">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-white">vacation_video.mp4</span>
                      <span className="text-red-400 font-medium">125.8 MB</span>
                    </div>
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-medium text-white">Optimized File</h4>
                  <div className={`bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 rounded-lg p-6 border border-emerald-500/30 transition-opacity duration-300 ${progress < 100 ? 'opacity-50' : 'opacity-100'}`}>
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-white">vacation_video_optimized.mp4</span>
                      <span className="text-emerald-400 font-medium">
                        {progress < 100 ? 'Processing...' : '12.3 MB'}
                      </span>
                    </div>
                    <div className="text-gray-300 text-sm">
                      Resolution: 1080p (1920x1080)<br/>
                      Duration: 2:34<br/>
                      Format: MP4 • {progress < 100 ? 'Optimizing...' : '90% smaller'}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                {progress === 100 && (
                  <div className="flex items-center justify-center pt-4">
                    <button className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 transition-all duration-200 transform hover:scale-105">
